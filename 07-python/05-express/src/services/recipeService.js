...
export const createRecipe = async ({
  ...
  const recipeId = await recipeModel.create({ userId, name, image, description, name_eng, abv, difficulty });
...
export const updateRecipe = async (id, userId, {
  ...
  await recipeModel.update(id, { name, image, description, name_eng, abv, difficulty });
